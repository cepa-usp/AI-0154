package model 
{
	...
	public class PlantLoader 
	{
		...
		public function load(mdl:Model):void {
			...
			p_1.hintsShow.push(p_1.hints[0]);
			mdl.plants.push(p_1);
			...
			p_2.hintsShow.push(p_2.hints[0]);
			mdl.plants.push(p_2);			
			...
			p_3.hintsShow.push(p_3.hints[0]);
			mdl.plants.push(p_3);			
			...
			p_4.hintsShow.push(p_4.hints[0]);
			mdl.plants.push(p_4);			
			...
			p_5.hintsShow.push(p_5.hints[0]);
			mdl.plants.push(p_5);			
			...
			p_6.hintsShow.push(p_6.hints[0]);
			mdl.plants.push(p_6);			
